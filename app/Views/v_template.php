...
<body>
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="index.html">Demo WebGIS</a>
        <!-- Sidebar Toggle-->
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <div class="sb-sidenav-menu-heading">Tanpa Basis Data</div>
                        ...
                        <a class="nav-link" href="<?= base_url('Home/coordinat') ?>">
                            <div class="sb-nav-link-icon"><i class="fa-solid fa-location-crosshairs"></i></div>
                            GetCoordinat
                        </a>

                        <a class="nav-link" href="<?= base_url('Home/coordinatRadius') ?>">
                            <div class="sb-nav-link-icon"><i class="fa-solid fa-location-crosshairs"></i></div>
                            GetCoordinat Radius
                        </a>
                        ...
                        <div class="sb-sidenav-menu-heading">Dengan Basis Data</div>
